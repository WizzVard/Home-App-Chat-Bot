...
class UISettings:
    ...
    def toggle_sidebar(state):
        ...
        :param state: The current state of the UI component.

        :return: Tuple: A tuple containing the updated UI component state and the new state.
        """
        state = not state
    ...
    def feedback(data: gr.LikeData):
        ...
        :param data: Gradio LikeData object containing user feedback.
        """
        if data.liked:
